...
<section class="content-header no-print">
    <h1>Total Reports Of {{ $contact->name }} </h1>
</section>
                ...
                <div class="col-sm-3">
                 ...
                 <div class="col-sm-3">
                    ...
                    @if( $contact->type == 'supplier' || $contact->type == 'customer' || $contact->type == 'both')
                        <strong>@lang('report.total_item_purchase')</strong>
                        <p class="text-muted">
                            {{ (int)$contact->TotalNoOfItemPurchased }}</span>
                        </p>
                        <strong>@lang('report.total_bonus_points')</strong>
                        <p class="text-muted">
                            {{ $contact->bonus_points }}</span>
                        </p>
                        <strong>@lang('report.total_conusmed_points')</strong>
                        <p class="text-muted">
                            {{ $contact->used_points }}</span>
                        </p>
                    @endif
