      ...
      <div class="col-md-4">
        <div class="form-group">
            ...
            <div class="input-group">
                ...
                {!! Form::number('discount', (isset($objBusiness['default_user_profit']))? $objBusiness['default_user_profit'] : 0 , ['class' => 'form-control','placeholder' => 'Discount %', 'required']); !!}
            </div>
        </div>
      </div>
      <div class="col-md-4">
        <div class="form-group">
            ...
            <div class="input-group">
                ...
                {!! Form::text('bonus_points', 0, ['class' => 'form-control','placeholder' => 'Bonus Points ', 'required']); !!}
            </div>
        </div>
      </div>
      ...
      <div class="col-md-4">
        <div class="form-group">
            ...
            <div class="input-group">
                ...
                {!! Form::text('contact_id', null, ['class' => 'form-control','placeholder' => 'Loyality Barcode']); !!}
            </div>
        </div>
      </div>
        <!-- <div class="col-md-4">
          <div class="form-group">
              {!! Form::label('barcode', 'Loyality Barcode' . ':') !!}
              <div class="input-group">
                  <span class="input-group-addon">
                      <i class="fa fa-info"></i>
                  </span>
                  {!! Form::text('barcode', null, ['class' => 'form-control', 'placeholder' =>'Loyality Barcode']); !!}
              </div>
          </div>
        </div>
