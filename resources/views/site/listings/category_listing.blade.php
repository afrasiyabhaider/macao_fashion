                                   ...
                                   <div class="product-default inner-quickview inner-icon">
                                        <figure>
                                             <a href="{{url('product/'.encrypt($item->products()->first()->id).'/detail')}}">
                                                       ...
                                                       <img src="{{asset('uploads/'.$images[0]->image)}}" style="height:350px;width:250px" class="img-thumbnail">
                                                       @if (isset($images[1]) && $images[1])
                                                            <img src="{{asset('uploads/'.$images[1]->image)}}" style="height:350px;width:250px" class="img-thumbnail">
                                                       @endif
                                                  @else
                                                       <img src="{{asset('img/product-placeholder-1.jpg')}}" id="preview1" alt="Image 1 Preview Here" style="height:350px;width:250px" class="img-thumbnail">
                                                       <img src="{{asset('img/product-placeholder-2.jpg')}}" id="preview1" alt="Image 1 Preview Here" style="height:350px;width:250px" class="img-thumbnail">
                                                  @endif
                                             </a>
