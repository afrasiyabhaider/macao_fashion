<!-- Main Footer -->
  <footer class="main-footer no-print">
    ...
    <!-- Default to the left -->
    <small>
    	{{ config('app.name', 'ultimatePOS') }} - V{{config('author.app_version')}} | Copyright &copy; {{ date('Y') }} All rights reserved. Powered By <b> <a href="https://www.linkedin.com/in/afrasiyab-haider-8bab20135/" target="_blank">Afrasiyab Haider</a></b>
    </small>
