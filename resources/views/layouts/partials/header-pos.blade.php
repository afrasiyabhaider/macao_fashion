...
<div class="col-md-12 no-print pos-header">
    ...
    <div class="row">
        ...
        <div class="col-md-5 pull-right">
            <span class=" btn btn-info  pull-right m-6  m-5" style="margin-right: 0; border-radius:0 !important;">
            ...
            <a href="{{ action('Auth\LoginController@logout') }}" title="LogOff" data-toggle="tooltip"
                data-placement="bottom" class="btn btn-danger btn-flat m-6  m-5 pull-right">
                <strong><i class="fa fa-sign-in fa-lg"></i> LogOff</strong>
            </a>


            <a href="{{ action('HomeController@index') }}" title="Dashboard" data-toggle="tooltip"
                data-placement="bottom" class="btn btn-success btn-flat m-6  m-5 pull-right">
                <strong><i class="fa fa-tachometer fa-lg"></i></strong>
            </a>

            <a href="#" onclick="openPopupWindow('/products');" title="Stocks" data-toggle="tooltip"
                data-placement="bottom" class="btn btn-info btn-flat m-6 m-5 pull-right">
        ...
        <strong><i class="fa fa-undo fa-lg"></i></strong>
            ...
            <a href="#" onclick="openPopupWindow('/products/bulk_add');" title="Bulk Product Add"
                data-toggle="tooltip" data-placement="bottom" class="btn btn-info btn-flat m-6  m-5 pull-right">
          ...
          data-href="{{ action('CashRegisterController@getCloseRegister')}}">
            ...
            <button type="button" id="register_details" title="{{ __('cash_register.register_details') }}"
                ...
                class="btn btn-success btn-flat m-6  m-5 btn-modal pull-right" data-container=".register_details_modal"
                data-href="{{ action('CashRegisterController@getRegisterDetails') }}">
                <strong><i class="fa fa-briefcase fa-lg" aria-hidden="true"></i></strong>
            </button>

            <button title="@lang('lang_v1.calculator')" id="btnCalculator" type="button"
                class="btn btn-success btn-flat pull-right m-5  mt-10 popover-default" data-toggle="popover"
        ...
        <div class="col-md-7">
            ...
            <div class="m-6 pull-left mt-15 hidden-xs "> <strong>{{ @format_date('now') }}</strong><strong
                    style="margin-left: 10px;" id="total_b_point"> </strong></div>
        </div>
