<div class="pos-tab-content active">
    <div class="row">
        ...
        <div class="col-sm-4">
            <div class="form-group">
                {!! Form::label('default_user_profit', 'Default User Percent '. ':*') !!} @show_tooltip(__('tooltip.default_profit_percent'))
                <div class="input-group">
                    <span class="input-group-addon">
                        <i class="fa fa-plus-circle"></i>
                    </span>
                    {!! Form::number('default_user_profit', $business->default_user_profit, ['class' => 'form-control', 'min' => 0, 
                    'step' => 0.01, 'max' => 100]); !!}
                </div>
            </div>
        </div>
