               ...
               <div class="row">
                    <div class="col-sm-4">
                         <div class="form-group">
                              ...
                              {!! Form::text('name', !empty($product->name) ? $product->name : null,
                    ...
                    <div class="col-sm-4">
                         <div class="form-group">
                              ...
                              {!! Form::text('refference', $product->refference, ['id'=>'refference_id','class' => 'req form-control
               ...
               <div class="row">
                    <div class="col-sm-4 @if(!session('business.enable_brand')) hide @endif">
                         <div class="form-group">
                              ...
                              <div class="input-group">
                                   {!! Form::select('supplier_id', $suppliers, !empty($product->supplier_id) ?
                                   $product->supplier_id : null, ['placeholder' =>
                    ...
                    <div class="col-sm-4 @if(!session('business.enable_category')) hide @endif">
                         <div class="form-group">
                              ...
                              <div class="input-group">
                                   {!! Form::select('category_id', $categories,!empty($product->category_id) ?
                                   $product->category_id : null,['placeholder' =>
                                   __('messages.please_select'), 'class' => 'req form-control select2', 'required' =>
                                   'true']); !!}
                    ...
                    <div
                         ...
                         <div class="form-group">
                              ...
                              <div class="input-group">
                                   ...
                                   !empty($product->sub_category_id) ? $product->sub_category_id :
               ...
               <div class="row">
                    ...
                    <div class="col-sm-4">
                         <div class="form-group">
                              ...
                              <input type="text" id="ref_description" name="ref_description" value="{{ $product->description }}" class="form-control opt"
                    ...
                    <div class="col-sm-4">
                         <div class="form-group">
                              ...
                              <div class="input-group">
                                   {!! Form::select('color_idc_ext', $colors, !empty($product->color_id) ? $product->color_id :
                                   null, ['placeholder' =>
               ...
               <div class="row">
                    ...
                    <div class="col-sm-4">
                         <div class="form-group">
                              ...
                              {!! Form::text('custom_price', $ut->num_f($product->variations()->first()->sell_price_inc_tax), ['class' => 'req form-control',
               ...
               <div class="row">
                    <div class="hide col-sm-3 @if(!session('business.enable_brand')) hide @endif">
                         <div class="form-group">
                              ...
                              <div class="input-group">
                                   {!! Form::select('brand_id', $brands, !empty($product->brand_id) ?
                                   $product->brand_id : null, ['placeholder' => __('messages.please_select'),
                    ...
                    <div class="col-sm-3 hide">
                         <div class="form-group">
                              ...
                              {!! Form::text('name_id', $product->name, ['class' => 'req form-control', 'required', 'placeholder' =>
          ...
          <div>
               ...
               <div class="col-sm-4 hide">
                    <div class="form-group">
                         ...
                         {!! Form::select('barcode_type', $barcode_types, !empty($product->barcode_type)
                         ? $product->barcode_type : $barcode_default, ['class' => 'form-control
                         select2']); !!}
                    </div>
               </div>
               <div class="col-sm-4 hide">
                    <div class="form-group">
                         <br>
                         <label>
                              {!! Form::checkbox('enable_stock', 1, !empty($product) ?
                              $product->enable_stock : true, ['class' => 'input-icheck', 'id' =>
               ...
               <div class="col-sm-4 hide @if(!empty($product) && $product->enable_stock == 0) hide @endif"
                    id="alert_quantity_div">
                    <div class="form-group">
                         {!! Form::label('alert_quantity', __('product.alert_quantity') . ':*') !!}
                         @show_tooltip(__('tooltip.alert_quantity'))
                         {!! Form::number('alert_quantity', !empty($product->alert_quantity) ?
                         $product->alert_quantity : null , ['class' => 'form-control',
               ...
               <div class="col-sm-8 hide">
                    <div class="form-group">
                         ...
                         {!! Form::textarea('product_description', !empty($product->product_description)
                         ? $product->product_description : null, ['class' => 'form-control']); !!}
                    </div>
               </div>
          </div>
     </div>
          ...
          <div class="row">
               ...
               <div class="col-sm-4 @if($hide) hide @endif">
                    <div class="form-group">
                         <div class="multi-input">
                              ...
                              {!! Form::text('expiry_period', !empty($product->expiry_period) ?
                              @num_format($product->expiry_period) : $expiry_period, ['class' => 'form-control
                              ...
                              !empty($product->expiry_period_type) ? $product->expiry_period_type :
               ...
               <div class="col-sm-4">
                    <div class="form-group">
                         <br>
                         <label>
                              {!! Form::checkbox('enable_sr_no', 1, !(empty($product)) ?
                              $product->enable_sr_no : false, ['class' => 'input-icheck']); !!}
               ...
               <div class="col-sm-4">
                    <div class="form-group">
                         ...
                         {!! Form::text('weight', !empty($product->weight) ? $product->weight :
               ...
               <div class="col-sm-3">
                    <div class="form-group">
                         ...
                         {!! Form::text('product_custom_field1', !empty($product->product_custom_field1) ?
                         $product->product_custom_field1 : null, ['class' => 'form-control', 'placeholder' =>
               ...
               <div class="col-sm-3">
                    <div class="form-group">
                         ...
                         {!! Form::text('product_custom_field2', !empty($product->product_custom_field2) ?
                         $product->product_custom_field2 : null, ['class' => 'form-control', 'placeholder' =>
               ...
               <div class="col-sm-3">
                    <div class="form-group">
                         ...
                         {!! Form::text('product_custom_field3', !empty($product->product_custom_field3) ?
                         $product->product_custom_field3 : null, ['class' => 'form-control', 'placeholder' =>
               ...
               <div class="col-sm-3">
                    <div class="form-group">
                         ...
                         {!! Form::text('product_custom_field4', !empty($product->product_custom_field4) ?
                         $product->product_custom_field4 : null, ['class' => 'form-control', 'placeholder' =>
          ...
          <div class="row">
               ...
               <div class="col-sm-4 @if(!session('business.enable_price_tax')) hide @endif">
                    <div class="form-group">
                         ...
                         {!! Form::select('tax', $taxes, !empty($product->tax) ? $product->tax :
               ...
               <div class="col-sm-4 @if(!session('business.enable_price_tax')) hide @endif">
                    <div class="form-group">
                         ...
                         __('product.exclusive')], !empty($product->tax_type) ? $product->tax_type :
                         'exclusive',
                         ['class' => 'form-control select2']); !!}
                    </div>
               </div>
               ...
               <div class="col-sm-4">
                    <div class="form-group">
                         ...
                         __('lang_v1.variable')], !empty($product->type) ? $product->type : null,
                         ['class' => 'form-control select2', 'data-action' => !empty($product) ? 'duplicate' :
                         'add', 'data-product_id' => !empty($product) ? $product->id : '0']); !!}
                    </div>
               </div>
...
<script type="text/javascript">
     $(document).ready(function (){
		...
		setTimeout(function(){
			$("#sub_category_id").val("{{ $product->sub_category_id }}").change();
...
// 	  }
     ...
     function changeUnitPrice(obj)
     {
        ...
        $("#single_dpp").val("{{ $ut->num_f($product->variations()->first()->dpp_inc_tax) }}").trigger("change");
    ...
    **/
    function clearAll(IsAnother = 0)
    {
      ...
      $("#sizeArea").empty();
      $("#sizeArea_ext").empty();
      var fieldsArr = ["supplier_id", "brand_id",  "name","upload_image","color_image","unit_price","ref_description","sku","chooseSize"];
