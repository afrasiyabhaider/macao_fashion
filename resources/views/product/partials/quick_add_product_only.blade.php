<div class="modal-dialog modal-lg" role="document">
  <div class="modal-content">
    {!! Form::open(['url' => action('ProductController@saveQuickProductOnly'), 'method' => 'post', 'id' => 'quick_add_product_form' ]) !!}
    ...
    <div class="modal-body">
      <div class="row">
        ...
        <div class="col-sm-4 hide">
          <div class="form-group">
            {!! Form::label('unit_id', __('product.unit') . ':*') !!}
              {!! Form::select('unit_id', $units, 1, ['placeholder' => __('messages.please_select'), 'class' => 'form-control select2', 'required']); !!}
          </div>
        </div> 
        <div class="col-sm-4 hide">
          <div class="form-group">
        ...
        <div class="col-sm-4">
          <div class="form-group">
            {!! Form::label('sku', 'Barcode :') !!} @show_tooltip(__('tooltip.sku'))
            {!! Form::text('sku', $autoBarcode, ['class' => 'form-control',
        ...
        <div class="col-sm-4 hide" id="alert_quantity_div">
          <div class="form-group">
            ...
            {!! Form::number('alert_quantity', 1, ['class' => 'form-control' ,
        ...
        <div class="col-sm-4 hide">
         ...
         <div class="col-sm-4">
          <div class="form-group">
            {!! Form::label('CustomPrice', 'Price :') !!}  
            {!! Form::text('CustomPrice', null, ['class' => 'form-control   dsp input_number', 'placeholder' => __('product.exc_of_tax'), 'id' => 'CustomPrice', 'required']); !!}
      ...
      <div class="row">
        <div class="form-group col-sm-11 col-sm-offset-1 ">
          @include('product.partials.s_p_f_p_quick', ['profit_percent' => $default_profit_percent])
        </div>
      </div>
      @if(!empty($product_for) && $product_for == 'pos')
        @include('product.partials.q_p_o_s', ['locations' => $locations])
      @endif
    </div>
