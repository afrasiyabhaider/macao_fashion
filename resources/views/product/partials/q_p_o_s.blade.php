<div class="row hide" id="quick_product_opening_stock_div" >
	<div class="col-sm-12">
	...
	<div class="col-sm-12">
		...
		@foreach($locations as $key => $value)
			<tr>
				<td>{{$value}}</td>
				<td>{!! Form::text('opening_stock[' . $key . '][quantity]', 1, ['class' => 'form-control input-sm input_number purchase_quantity', 'required']); !!}</td>
				<td>{!! Form::text('opening_stock[' . $key . '][purchase_price]', 1 , ['class' => 'form-control input-sm input_number unit_price', 'required']); !!}</td>
				@if($enable_expiry)
					<td>
