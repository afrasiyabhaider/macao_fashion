            ...
            @foreach ($product as $objProduct)
                ...
                @for ($j = 0; $j < $objProduct['count']; $j++)
                    <div class="col-md-4 col-xs-4 heh mt-sm-3">
                        ...
                        <div class="col-xs-12">
                            <div class="col-xs-3 printList" id="defualt_price" data-id="price"
                            ...
                            <div class="col-xs-3 priceList hideV" id="oldPrice"
                                style="font-weight: bolder; font-size: 12px">
                                {{-- <span>
                                    €
                                </span> --}}
                                ...
                                @if ($objProduct['max_price'] != $objProduct['min_price'] && $objProduct['type'] == 'variable')
                                    - <span class="display_currency" data-currency_symbol="true">
                                        {{ $objProduct['old_price']!=null?'€'.$objProduct['old_price']:'' }}
                                    </span>
                                @else
                                    <span class="display_currency" data-currency_symbol="true">
                                        {{$objProduct['old_price']!=null?'€'.$objProduct['old_price']:''  }}
