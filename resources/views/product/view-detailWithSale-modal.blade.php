                    ...
                    <div class="col-md-12">
                         <div class="table-responsive">
                              <table class="table table-condensed bg-gray">
                                   ...
                                   <tr>
                                        <td>
                                             <img src=" {{ $row->image_url }}" alt="Product image" class="product-thumbnail-small">
                                        </td>
                                        <td>
                                             @if ($row->refference)
                                                  {{ $row->refference }}
                                        ...
                                        <td>
                                             <span class="display_currency row_subtotal" data-currency_symbol=true data-orig-value="{{ $row->subtotal }} ">
                                                  {{ $row->subtotal }}
                                             </span>
                                        </td>
                                        <td>
