        ...
        <div class="row check_group">
          ...
          <div class="col-md-9">
            <div class="col-md-12">
              <div class="checkbox">
                <label>
                  {!! Form::checkbox('permissions[]', 'gift.view', in_array('gift.view', $role_permissions), 
                  [ 'class' => 'input-icheck']); !!} {{ __( 'gift.gifts_view' ) }}
                </label>
              </div>
            </div>
            <div class="col-md-12">
              <div class="checkbox">
                <label>
                  {!! Form::checkbox('permissions[]', 'gift.create', in_array('gift.create', $role_permissions), 
                  [ 'class' => 'input-icheck']); !!} {{ __( 'gift.gifts_add' ) }}
                </label>
              </div>
            </div>
            <div class="col-md-12">
              <div class="checkbox">
                <label>
                  {!! Form::checkbox('permissions[]', 'gift.reports', in_array('gift.reports', $role_permissions), 
                  [ 'class' => 'input-icheck']); !!} {{ __( 'gift.gifts_report' ) }}
                </label>
              </div>
            </div> 
          </div>
        ...
        <div class="row check_group">
          ...
          <div class="col-md-9">
            <div class="col-md-12">
              <div class="checkbox">
                <label>
                  {!! Form::checkbox('permissions[]', 'coupon.view', in_array('coupon.view', $role_permissions), 
                  [ 'class' => 'input-icheck']); !!} {{ __( 'coupon.gifts_view' ) }}
                </label>
              </div>
            </div>
            <div class="col-md-12">
              <div class="checkbox">
                <label>
                  {!! Form::checkbox('permissions[]', 'coupon.create', in_array('coupon.create', $role_permissions), 
                  [ 'class' => 'input-icheck']); !!} {{ __( 'coupon.gifts_add' ) }}
                </label>
              </div>
            </div>
            ...
            <div class="col-md-12">
              <div class="checkbox">
                <label>
                  {!! Form::checkbox('permissions[]', 'coupon.reports', in_array('coupon.reports', $role_permissions), 
                  [ 'class' => 'input-icheck']); !!} {{ __( 'coupon.gifts_report' ) }}
                </label>
              </div>
            </div> 
          </div>
        ...
        <div class="row check_group">
          ...
          <div class="col-md-9">
            <div class="col-md-12">
              <div class="checkbox">
                <label>
                  {!! Form::checkbox('permissions[]', 'size.view', in_array('size.view', $role_permissions), 
                  [ 'class' => 'input-icheck']); !!} {{ 'VIEW' }}
                </label>
              </div>
            </div>
            <div class="col-md-12">
              <div class="checkbox">
                <label>
                  {!! Form::checkbox('permissions[]', 'size.create', in_array('size.create', $role_permissions), 
                  [ 'class' => 'input-icheck']); !!} {{ 'CREATE' }}
                </label>
              </div>
            </div>
            <div class="col-md-12 hide">
              <div class="checkbox">
                <label>
                  {!! Form::checkbox('permissions[]', 'size.add', in_array('size.add', $role_permissions), 
                  [ 'class' => 'input-icheck']); !!} {{ 'ADD' }}
                </label>
              </div>
            </div>
            <div class="col-md-12">
              <div class="checkbox">
                <label>
                  {!! Form::checkbox('permissions[]', 'size.edit', in_array('size.edit', $role_permissions), 
                  [ 'class' => 'input-icheck']); !!} {{ 'EDIT' }}
                </label>
              </div>
            </div>
            <div class="col-md-12">
              <div class="checkbox">
                <label>
                  {!! Form::checkbox('permissions[]', 'size.delete', in_array('size.delete', $role_permissions), 
                  [ 'class' => 'input-icheck']); !!} {{ 'DELETE' }}
                </label>
              </div>
            </div>
            ...
            <div class="col-md-12">
              <div class="checkbox">
                <label>
                  {!! Form::checkbox('permissions[]', 'size.update', in_array('size.update', $role_permissions), 
                  [ 'class' => 'input-icheck']); !!} {{ 'UPDATE' }}
                </label>
              </div>
            </div>
            ...
            <div class="col-md-12 hide">
              <div class="checkbox">
                <label>
                  {!! Form::checkbox('permissions[]', 'size.index', in_array('size.index', $role_permissions), 
                  [ 'class' => 'input-icheck']); !!} {{ 'INDEX' }}
                </label>
              </div>
            </div>
        ...
        <div class="row check_group">
          ...
          <div class="col-md-9">
            <div class="col-md-12">
              <div class="checkbox">
                <label>
                  {!! Form::checkbox('permissions[]', 'color.view', in_array('color.view', $role_permissions), 
                  [ 'class' => 'input-icheck']); !!} {{ 'VIEW' }}
                </label>
              </div>
            </div>
            <div class="col-md-12">
              <div class="checkbox">
                <label>
                  {!! Form::checkbox('permissions[]', 'color.create', in_array('color.create', $role_permissions), 
                  [ 'class' => 'input-icheck']); !!} {{ 'CREATE' }}
                </label>
              </div>
            </div>
            <div class="col-md-12 hide">
              <div class="checkbox">
                <label>
                  {!! Form::checkbox('permissions[]', 'color.add', in_array('color.add', $role_permissions), 
                  [ 'class' => 'input-icheck']); !!} {{ 'ADD' }}
                </label>
              </div>
            </div>
            <div class="col-md-12">
              <div class="checkbox">
                <label>
                  {!! Form::checkbox('permissions[]', 'color.edit', in_array('color.edit', $role_permissions), 
                  [ 'class' => 'input-icheck']); !!} {{ 'EDIT' }}
                </label>
              </div>
            </div>
            <div class="col-md-12">
              <div class="checkbox">
                <label>
                  {!! Form::checkbox('permissions[]', 'color.delete', in_array('color.delete', $role_permissions), 
                  [ 'class' => 'input-icheck']); !!} {{ 'DELETE' }}
                </label>
              </div>
            </div>
            ...
            <div class="col-md-12">
              <div class="checkbox">
                <label>
                  {!! Form::checkbox('permissions[]', 'color.update', in_array('color.update', $role_permissions), 
                  [ 'class' => 'input-icheck']); !!} {{ 'UPDATE' }}
                </label>
              </div>
            </div>
            ...
            <div class="col-md-12 hide">
              <div class="checkbox">
                <label>
                  {!! Form::checkbox('permissions[]', 'color.index', in_array('color.index', $role_permissions), 
                  [ 'class' => 'input-icheck']); !!} {{ 'INDEX' }}
                </label>
              </div>
            </div>
        ...
        <div class="row check_group">
          ...
          <div class="col-md-9">
            ...
            <div class="col-md-12 hide">
              <div class="checkbox">
                <label>
                  {!! Form::checkbox('permissions[]', 'supplier.add', in_array('supplier.add', $role_permissions), 
                  [ 'class' => 'input-icheck']); !!} {{ 'ADD' }}
                </label>
              </div>
            </div>
            <div class="col-md-12">
              <div class="checkbox">
                <label>
                  {!! Form::checkbox('permissions[]', 'supplier.edit', in_array('supplier.edit', $role_permissions), 
                  [ 'class' => 'input-icheck']); !!} {{ 'EDIT' }}
                </label>
              </div>
            </div>
            ...
            <div class="col-md-12 hide">
              <div class="checkbox">
                <label>
                  {!! Form::checkbox('permissions[]', 'supplier.index', in_array('supplier.index', $role_permissions), 
                  [ 'class' => 'input-icheck']); !!} {{ 'INDEX' }}
                </label>
              </div>
            </div>
...
<!-- Tc UPDATE ENDS -->
        ...
        <div class="col-md-9">
          ...
          <div class="col-md-12">
            <div class="checkbox">
              <label>
                {!! Form::checkbox('permissions[]', 'stock_in_out.view', in_array('stock_in_out.view', $role_permissions), 
          ...
          <div class="col-md-12">
            <div class="checkbox">
              <label>
                {!! Form::checkbox('permissions[]', 'coupon_report.view', in_array('coupon_report.view', $role_permissions), 
