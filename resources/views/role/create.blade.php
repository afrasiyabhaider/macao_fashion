        ...
        <div class="row check_group">
          ...
          <div class="col-md-9">
            <div class="col-md-12">
              <div class="checkbox">
                <label>
                  {!! Form::checkbox('permissions[]', 'gift.view', false, 
            ...
            <div class="col-md-12">
              <div class="checkbox">
                <label>
                  {!! Form::checkbox('permissions[]', 'gift.create', false, 
            ...
            <div class="col-md-12">
              <div class="checkbox">
                <label>
                  {!! Form::checkbox('permissions[]', 'gift.reports', false, 
        ...
        <div class="row check_group">
          ...
          <div class="col-md-9">
            <div class="col-md-12">
              <div class="checkbox">
                <label>
                  {!! Form::checkbox('permissions[]', 'coupon.view', false, 
            ...
            <div class="col-md-12">
              <div class="checkbox">
                <label>
                  {!! Form::checkbox('permissions[]', 'coupon.create', false, 
            ...
            <div class="col-md-12">
              <div class="checkbox">
                <label>
                  {!! Form::checkbox('permissions[]', 'coupon.reports', false, 
        ...
        <div class="row check_group">
          ...
          <div class="col-md-9">
            <div class="col-md-12">
              <div class="checkbox">
                <label>
                  {!! Form::checkbox('permissions[]', 'size.view', false, 
            ...
            <div class="col-md-12">
              <div class="checkbox">
                <label>
                  {!! Form::checkbox('permissions[]', 'size.create', false, 
            ...
            <div class="col-md-12 hide">
              <div class="checkbox">
                <label>
                  {!! Form::checkbox('permissions[]', 'size.add', true, 
            ...
            <div class="col-md-12">
              <div class="checkbox">
                <label>
                  {!! Form::checkbox('permissions[]', 'size.edit', false, 
            ...
            <div class="col-md-12">
              <div class="checkbox">
                <label>
                  {!! Form::checkbox('permissions[]', 'size.delete', false, 
            ...
            <div class="col-md-12">
              <div class="checkbox">
                <label>
                  {!! Form::checkbox('permissions[]', 'size.update', false, 
            ...
            <div class="col-md-12 hide">
              <div class="checkbox">
                <label>
                  {!! Form::checkbox('permissions[]', 'size.index', true, 
        ...
        <div class="row check_group">
          ...
          <div class="col-md-9">
            <div class="col-md-12">
              <div class="checkbox">
                <label>
                  {!! Form::checkbox('permissions[]', 'color.view', false, 
                  [ 'class' => 'input-icheck']); !!} {{ 'VIEW' }}
                </label>
              </div>
            </div>
            <div class="col-md-12">
              <div class="checkbox">
                <label>
                  {!! Form::checkbox('permissions[]', 'color.create', false, 
                  [ 'class' => 'input-icheck']); !!} {{ 'CREATE' }}
                </label>
              </div>
            </div>
            <div class="col-md-12 hide">
              <div class="checkbox">
                <label>
                  {!! Form::checkbox('permissions[]', 'color.add', true, 
                  [ 'class' => 'input-icheck']); !!} {{ 'ADD' }}
                </label>
              </div>
            </div>
            <div class="col-md-12">
              <div class="checkbox">
                <label>
                  {!! Form::checkbox('permissions[]', 'color.edit', false, 
                  [ 'class' => 'input-icheck']); !!} {{ 'EDIT' }}
                </label>
              </div>
            </div>
            <div class="col-md-12">
              <div class="checkbox">
                <label>
                  {!! Form::checkbox('permissions[]', 'color.delete', false, 
                  [ 'class' => 'input-icheck']); !!} {{ 'DELETE' }}
                </label>
              </div>
            </div>
            ...
            <div class="col-md-12">
              <div class="checkbox">
                <label>
                  {!! Form::checkbox('permissions[]', 'color.update', false, 
                  [ 'class' => 'input-icheck']); !!} {{ 'UPDATE' }}
                </label>
              </div>
            </div>
            ...
            <div class="col-md-12 hide">
              <div class="checkbox">
                <label>
                  {!! Form::checkbox('permissions[]', 'color.index', true, 
                  [ 'class' => 'input-icheck']); !!} {{ 'INDEX' }}
                </label>
              </div>
            </div>
        ...
        <div class="row check_group">
          ...
          <div class="col-md-9">
            ...
            <div class="col-md-12 hide">
              <div class="checkbox">
                <label>
                  {!! Form::checkbox('permissions[]', 'supplier.add', true, 
                  [ 'class' => 'input-icheck']); !!} {{ 'ADD' }}
                </label>
              </div>
            </div>
            <div class="col-md-12">
              <div class="checkbox">
                <label>
                  {!! Form::checkbox('permissions[]', 'supplier.edit', false, 
                  [ 'class' => 'input-icheck']); !!} {{ 'EDIT' }}
                </label>
              </div>
            </div>
            ...
            <div class="col-md-12 hide">
              <div class="checkbox">
                <label>
                  {!! Form::checkbox('permissions[]', 'supplier.index', true, 
                  [ 'class' => 'input-icheck']); !!} {{ 'INDEX' }}
                </label>
              </div>
            </div>
