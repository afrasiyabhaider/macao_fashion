						...
						<div class="row">
							<div id="payment_rows_div">
								@foreach($payment_lines as $payment_line)
									...
									@include('sale_pos.partials.payment_row', ['removable' => !$loop->first, 'row_index' => $loop->index, 'payment_line' => $payment_line,'sell_line_note' => (isset($sell_details[0]))?$sell_details[0]->sell_line_note:"0"])
								@endforeach
							</div>
