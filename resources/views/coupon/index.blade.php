    ...
    @component('components.filters', ['title' => __('report.filters')])
        <div class="col-md-3">
            <div class="form-group">
                ...
                {!! Form::select('isActive', ['active' => 'Active', 'expired'=> 'Expired', 'consumed'=> 'Consumeded', 'cancell'=> 'Cancelled'], null, ['class' => 'form-control select2', 'style' => 'width:100%', 'id' => 'product_list_filter_type', 'placeholder' => __('lang_v1.all')]); !!}
            </div>
        </div>
           ...
           <!-- Custom Tabs -->
            <div class="nav-tabs-custom">
                <ul class="nav nav-tabs">
                    <li class="active">
                        <a href="#product_list_tab" data-toggle="tab" aria-expanded="true"><i class="fa fa-cubes" aria-hidden="true"></i> @lang('coupon.all')</a>
                    </li>
                ...
                <div class="tab-content">
                    <div class="tab-pane active" id="product_list_tab">
                        @can('coupon.create')
                            <a class="btn btn-primary pull-right" href="{{action('CouponController@create')}}">
                                        <i class="fa fa-plus"></i> @lang('messages.add')</a>
                            <br><br>
                        @endcan
                        @include('coupon.partials.coupon_list')
                    </div>
        ...
        $(document).ready( function(){
            product_table = $('#product_table').DataTable({
                ...
                columns: [
                        ...
                        { data: 'value', name: 'coupons.value'  },
                        { data: 'barcode', name: 'coupons.barcode', searchable: false},
                        { data: 'start_date', name: 'coupons.start_date'},
                        { data: 'GiftCardBarcode', name: 'GiftCardBarcode'},
                        { data: 'CouponExpiryDate', name: 'coupons.start_date'},
                        { data: 'details', name: 'coupons.details'},
                        { data: 'isActive', name: 'coupons.isActive',visible:false},
                        { data: 'isActive', name: 'coupons.isActive',visible:false},
                        { data: 'isActive', name: 'coupons.isActive'},
