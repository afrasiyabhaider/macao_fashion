    ...
    <table class="table table-bordered table-striped ajax_view table-text-center" id="product_table">
        <thead>
            <tr>
                ...
                <th>@lang('coupon.value')</th>
                <th>@lang('coupon.barcode')</th>
                <th>@lang('coupon.start_date')</th>
                <th>@lang('coupon.gift_card')</th>
                <th>@lang('coupon.expiry_date')</th>
                <th>@lang('coupon.details')</th>
                <th> </th>
                <th> </th>
                <th>@lang('coupon.is_active')</th>
        ...
        <tfoot>
            <tr>
                ...
                <div style="display: flex; width: 100%;">
                    @can('product.delete')
                        {!! Form::open(['url' => action('CouponController@massDestroy'), 'method' => 'post', 'id' => 'mass_delete_form' ]) !!}
                        {!! Form::hidden('selected_rows', null, ['id' => 'selected_rows']); !!}
                        {!! Form::submit(__('lang_v1.delete_selected'), array('class' => 'btn btn-xs btn-danger', 'id' => 'delete-selected')) !!}
                        {!! Form::close() !!}
                    @endcan
                    &nbsp;
                    {!! Form::open(['url' => action('CouponController@massDeactivate'), 'method' => 'post', 'id' => 'mass_deactivate_form' ]) !!}
