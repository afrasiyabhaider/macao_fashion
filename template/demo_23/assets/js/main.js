...
(function ($) {
  ...
  var Porto = {
    ...
    stickySidebar: function () {
      $("main>.sidebar-shop .sidebar-wrapper, main>.sidebar-product .sidebar-wrapper").themeSticky({
        autoInit: true,
        minWidth: 768,
      ...
      $("main * .sidebar-wrapper, main * .sidebar-wrapper, main * .sticky-slider").themeSticky({
        autoInit: true,
        minWidth: 991,
