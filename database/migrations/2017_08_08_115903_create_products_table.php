...
class CreateProductsTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('products', function (Blueprint $table) {
            ...
            $table->foreign('business_location_id')->references('id')->on('business')->onDelete('cascade');
            ...
            $table->string('bulk_add')->nullable();
            $table->integer('supplier_id')->unsigned()->nullable();
            
            $table->integer('color_id')->unsigned()->nullable();
            
            $table->integer('size_id')->unsigned()->nullable();
            $table->integer('sub_size_id')->unsigned()->nullable();
            ...
            $table->enum('p_type', ['product', 'gift_card', 'coupon']);
            $table->integer('gift_card')->nullable();
