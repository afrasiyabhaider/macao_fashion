...
class BusinessLocation extends Model
{
    ...
    public static function forDropdownOrignal($business_id, $show_all = false, $receipt_printer_type_attribute = false, $append_id = true)
    {
        $query = BusinessLocation::where('business_id', $business_id);
     ...
     public static function forDropdown($business_id, $show_all = false, $receipt_printer_type_attribute = false, $append_id = true)
    {
        ...
        //     $query = BusinessLocation::where('business_id', $business_id);
        // }else{
        //     $query = BusinessLocation::where('business_id', $business_id)->where('id', $user->business_location_id);
        // }
        $query = BusinessLocation::where('business_id', $business_id);
