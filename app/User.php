...
class User extends Authenticatable
{
     ...
     */
    protected $fillable = [
        'surname', 'first_name', 'last_name', 'username', 'email', 'password', 'business_id', 'business_location_id', 'is_cmmsn_agnt', 'contact_no', 'address', 'cmmsn_percent', 'language', 'selected_contacts', 'status'
    ];
     ...
     */
    public static function permitted_locations($all = false)
    {
        if($all)
        {
            return 'all'; // Tc update for jugaad
        }
